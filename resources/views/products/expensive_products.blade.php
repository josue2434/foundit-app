<x-app-layout>
    <div class="p-6">
        <div class="mb-6 flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-[#2045c2] inline-block bg-white bg-opacity-80 px-4 py-2 rounded-lg shadow-sm">MATERIALES ALTO VALOR</h1>
        </div>
    ...
    <div id="background-overlay" style="
        ...
        width: 100%;
        height: 100%;
        background-image: url('{{ asset('img/prod3.jpg') }}');
